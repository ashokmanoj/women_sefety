...
import {
  UserPlus, Edit2, Trash2, Star, Phone, Mail, Heart
} from 'lucide-react';
...
export default function ContactManager() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const contactData: Partial<Contact> = {
      ...(selectedContact && { _id: selectedContact._id }),
      ...formData,
    ...
    if (selectedContact) {
      await dispatch(updateContact(contactData as Contact));
    } else {
      await dispatch(saveContact(contactData as Contact));
    }
